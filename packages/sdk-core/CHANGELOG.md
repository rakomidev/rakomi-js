...
- Add passkey (WebAuthn) support: `registerPasskey`, `assertPasskey`, `stepUpWithPasskey`, and the passkey management client (`listPasskeys` / `renamePasskey` / `deletePasskey`).
