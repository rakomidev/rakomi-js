...
const TAG_PREFIX_TARGETS = Object.freeze([
  ...
  Object.freeze({ prefix: 'create-rakomi-app/v', packageName: 'create-rakomi-app', publishedBy: 'rakomidev/rakomi-js publish.yml (create-rakomi-app/v*)' }),
  Object.freeze({ prefix: 'cli/v', packageName: 'rakomi', publishedBy: 'rakomidev/rakomi-js publish.yml (cli/v*)' }),
])
